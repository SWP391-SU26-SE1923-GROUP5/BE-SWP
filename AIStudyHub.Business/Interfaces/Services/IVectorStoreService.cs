...
public interface IVectorStoreService
{
    ...
    Task<List<(string Id, float[] Embedding, Dictionary<string, string> Metadata)>> SearchAsync(float[] queryEmbedding, int topK, Dictionary<string, string>? filterMetadata = null);
