...
public interface IQuizSubmissionService
{
    ...
    Task<PagedResultDto<QuizSubmissionHistoryDto>> GetQuizHistoryAsync(Guid quizId, DateTime? fromDate, DateTime? toDate, PaginationParams @params, CancellationToken ct = default);
