...
/// <summary>
/// Plan C3 / B.2.2: return value of <c>QuizSubmissionService.CreateAsync</c>.
/// Wraps the submission + a list of badges the user JUST unlocked so the frontend
/// can celebrate without an extra round-trip to <c>/api/Gamification/achievements</c>.
/// </summary>
